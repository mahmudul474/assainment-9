  ...
  return (
    ...
    <div  className="hidden py-20 text-center bg-blue-100 dark:bg-gray-700 lg:block">
        <div  className="max-w-6xl mx-auto mb-24">
            <span  className="inline-block text-base font-medium text-red-600 dark:text-blue-300">Welcome Back</span>
            <h2  className="mb-6 font-semibold text-gray-800 text-7xl dark:text-gray-300">Login our account</h2>
    ...
    <div  className="max-w-xl mx-auto ">
        <div  className="w-full shadow-lg bg-gray-50 dark:bg-gray-800 mt-11 lg:-mt-36 lg:full p-7 rounded-3xl">
            <span  className="flex justify-end mb-8">
                <a href=""  className="px-4 py-3 text-sm font-medium text-gray-100 bg-blue-700 hover:text-blue-200 rounded-lg">
                    Register Account
                </a>
            </span>
            <div  className="">
                <form action=""  className="p-0 m-0">
                    ...
                    <div  className="py-5 text-base text-center text-gray-600 dark:text-gray-400">Or login with</div>
                    <div  className="flex justify-center">
                        <a href=""  className="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="30" fill="currentColor"
                                 className="mr-6 text-blue-700 dark:text-blue-400 bi bi-facebook" viewBox="0 0 16 16">
                                <path
                        ...
                        <a href=""  className="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="30" fill="currentColor"
                                 className="mr-6 text-green-600 dark:text-green-400 bi bi-whatsapp" viewBox="0 0 16 16">
                                <path
                        ...
                        <a href=""  className="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="30" fill="currentColor"
                                 className="mr-6 text-blue-500 dark:text-blue-400 bi bi-twitter" viewBox="0 0 16 16">
                                <path
                        ...
                        <a href=""  className="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="30" fill="currentColor"
                                 className="text-red-600 dark:text-red-400 bi bi-linkedin " viewBox="0 0 16 16">
                                <path
