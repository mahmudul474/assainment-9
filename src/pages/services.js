...
export default function Services() {
  return (
    ...
    <h2 class="text-2xl font-bold dark:text-gray-400">Product Categories</h2>
    ...
    <a href="#" class="text-base font-medium text-blue-500 hover:underline dark:text-blue-400">View
    More</a>
    </div>
    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
    <h2 class="text-2xl font-bold dark:text-gray-400 ">Size</h2>
    <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
    <div class="flex flex-wrap -mx-2 -mb-2">
    <button class="py-1 mb-2 mr-1 border w-11 hover:border-blue-400 dark:border-gray-400 hover:text-blue-600 dark:hover:border-gray-300 dark:text-gray-400">XL
    </button>
    <button class="py-1 mb-2 mr-1 border w-11 hover:border-blue-400 hover:text-blue-600 dark:border-gray-400 dark:hover:border-gray-300 dark:text-gray-400">S
    </button>
    <button class="py-1 mb-2 mr-1 border w-11 hover:border-blue-400 hover:text-blue-600 dark:border-gray-400 dark:hover:border-gray-300 dark:text-gray-400">M
    </button>
    <button class="py-1 mb-2 mr-1 border w-11 hover:border-blue-400 hover:text-blue-600 dark:border-gray-400 dark:hover:border-gray-300 dark:text-gray-400">XS
    </button>
    </div>
    </div>
    <div class="p-4 mb-5 bg-white border border-gray-200 dark:border-gray-900 dark:bg-gray-900">
    <h2 class="text-2xl font-bold dark:text-gray-400">Colors</h2>
    <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
    <div class="flex flex-wrap -mx-2 -mb-2">
    ...
    <input type="checkbox" class="w-4 h-4 mr-2" />
    <span class="text-lg dark:text-gray-400">Amul</span>
    </label>
    </li>
    <li class="mb-4">
    <label for="" class="flex items-center dark:text-gray-300">
    <input type="checkbox" class="w-4 h-4 mr-2" />
    <span class="text-lg dark:text-gray-400">RIGO</span>
    </label>
    </li>
    <li class="mb-4">
    <label for="" class="flex items-center dark:text-gray-300">
    <input type="checkbox" class="w-4 h-4 mr-2" />
    <span class="text-lg dark:text-gray-400">Nyptra</span>
    </label>
    </li>
    <li class="mb-4">
    <label for="" class="flex items-center dark:text-gray-300">
    <input type="checkbox" class="w-4 h-4 mr-2" />
    <span class="text-lg dark:text-gray-400">Shangri-la </span>
    </label>
    </li>
    </ul>
    <a href="#" class="text-base font-medium text-blue-500 hover:underline dark:text-blue-400">View
    ...
    <div class="px-3 ">
    <div class="items-center justify-between hidden px-4 py-2 mb-4 bg-gray-100 md:flex dark:bg-gray-900 ">
    <h2 class="text-2xl dark:text-gray-400">Search Results for items</h2>
    <div class="flex items-center justify-between">
    <div class="flex">
    <a href="#" class="inline-block h-full p-2 mr-3 border rounded-md bg-gray-50 dark:text-gray-400 dark:bg-gray-700 dark:border-gray-700">
    ...
    <a href="#" class="inline-block h-full p-2 mr-6 border rounded-md bg-gray-50 dark:text-gray-400 dark:bg-gray-700 dark:border-gray-700">
    ...
    <div>
    <select name="" id="" class="block w-40 text-base bg-gray-100 dark:text-gray-400 dark:bg-gray-900">
    ...
    <div class="border border-gray-200 rounded-md dark:border-gray-800">
    ...
    <a href="#" class="">
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="text-red-500 dark:text-gray-400 bi bi-heart" viewBox="0 0 16 16">
    ...
    <div class="mb-4 ">
    <p class="text-lg ">
    <span class="text-red-400 dark:text-gray-400">$800.00</span>
    <span class="ml-2 text-gray-400 line-through dark:text-gray-400">1500</span>
    </p>
    </div>
    <div class="flex items-center justify-between mb-4">
    <ul class="flex ">
    <li>
    <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="w-4 mr-1 text-yellow-500 dark:text-gray-400 bi bi-star " viewBox="0 0 16 16">
    <path d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.522-3.356c.33-.314.16-.888-.282-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767-3.686 1.894.694-3.957a.565.565 0 0 0-.163-.505L1.71 6.745l4.052-.576a.525.525 0 0 0 .393-.288L8 2.223l1.847 3.658a.525.525 0 0 0 .393.288l4.052.575-2.906 2.77a.565.565 0 0 0-.163.506l.694 3.957-3.686-1.894a.503.503 0 0 0-.461 0z"></path>
    </svg></a>
    </li>
    <li>
    <a href="#">
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="w-4 mr-1 text-yellow-500 dark:text-gray-400 bi bi-star" viewBox="0 0 16 16">
    <path d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.522-3.356c.33-.314.16-.888-.282-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767-3.686 1.894.694-3.957a.565.565 0 0 0-.163-.505L1.71 6.745l4.052-.576a.525.525 0 0 0 .393-.288L8 2.223l1.847 3.658a.525.525 0 0 0 .393.288l4.052.575-2.906 2.77a.565.565 0 0 0-.163.506l.694 3.957-3.686-1.894a.503.503 0 0 0-.461 0z"></path>
    </svg>
    </a>
    </li>
    ...
    <a href="#" class="flex justify-center px-4 py-2 text-blue-600 border border-blue-300 rounded-full dark:border-gray-600 dark:text-gray-400 hover:bg-blue-700 hover:text-gray-100 dark:hover:bg-gray-800 dark:hover:border-gray-900">
    Add to cart</a>
    </div>
    </div>
    </div>
    ...
    <div class="mb-4 ">
    <p class="text-lg ">
    <span class="text-red-400 dark:text-gray-400">$900.00</span>
    <span class="ml-2 text-gray-400 line-through dark:text-gray-400">1600</span>
    </p>
    </div>
    <div class="flex items-center justify-between mb-4">
    <ul class="flex ">
    ...
    <div class="mb-4 ">
    <p class="text-lg ">
    <span class="text-red-400 dark:text-gray-400">$1000.00</span>
    <span class="ml-2 text-gray-400 line-through dark:text-gray-400">1500</span>
    </p>
    </div>
    <div class="flex items-center justify-between mb-4">
    ...
    <div class="mb-4 ">
    <p class="text-lg ">
    <span class="text-red-400 dark:text-gray-400">$700.00</span>
    <span class="ml-2 text-gray-400 line-through dark:text-gray-400">1500</span>
    </p>
    </div>
    <div class="flex items-center justify-between mb-4">
    ...
    <div class="mb-4 ">
    <p class="text-lg ">
    <span class="text-red-400 dark:text-gray-400">$600.00</span>
    <span class="ml-2 text-gray-400 line-through dark:text-gray-400">1500</span>
    </p>
    </div>
    <div class="flex items-center justify-between mb-4">
    ...
    <p class="text-lg ">
    <span class="text-red-400 dark:text-gray-400">$900.00</span>
    <span class="ml-2 text-gray-400 line-through dark:text-gray-400">1900</span>
    </p>
    </div>
    <div class="flex items-center justify-between mb-4">
    <ul class="flex ">
    ...
    <li class="page-item ">
    <a href="#" class="relative block px-3 py-1.5 mr-3 text-base hover:text-blue-700 transition-all duration-300 hover:bg-blue-200 dark:hover:text-gray-400 dark:hover:bg-gray-700 rounded-md text-gray-100 bg-blue-600">1
    </a>
    </li>
    <li class="page-item ">
