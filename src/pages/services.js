...
import { useGetFilteredProductsQuery, useSearchProductsQuery } from "@/redux/api/api";
...
export default function Services() {
  ...
  const { data: filteredProducts, error: filterError, isLoading: filterLoading } = useGetFilteredProductsQuery({
    filter,
    sort,
    page,
  });

  const { data: searchResults, error: searchError, isLoading: searchLoading } = useSearchProductsQuery({
    searchTerm,
    page,
  });
  ...
  return (
    <Layout>
      ...
      <section class=" bg-gray-50 font-poppins dark:bg-gray-800 ">
            ...
            <div class="w-full px-3 lg:w-3/4">
              <div class="px-3 ">
                <div class="items-center justify-between hidden px-4 py-2 mb-4 bg-gray-100 md:flex dark:bg-gray-900 ">
                  <h2 class="text-2xl dark:text-gray-400">
                  ...
                  <div class="flex items-center justify-between">
                    <div class="flex">
                      <a
                        href="#"
                        class="inline-block h-full p-2 mr-3 border rounded-md bg-gray-50 dark:text-gray-400 dark:bg-gray-700 dark:border-gray-700"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
                      ...
                      <a
                        href="#"
                        class="inline-block h-full p-2 mr-6 border rounded-md bg-gray-50 dark:text-gray-400 dark:bg-gray-700 dark:border-gray-700"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
                          height="16"
                          fill="currentColor"
                          class="w-5 h-5 bi bi-grid-3x3-gap-fill"
                          viewBox="0 0 16 16"
                        >
                    ...
                    <div>
                      <select
                        name=""
                        id=""
                        class="block w-40 text-base bg-gray-100 dark:text-gray-400 dark:bg-gray-900"
                      >
                  ...
                  <div class="border border-gray-200 rounded-md dark:border-gray-800">
                    <div class="relative bg-gray-200">
                      ...
                      <div class="absolute top-0 right-0 z-10 m-1 flex items-center justify-center w-16 h-16 p-5 text-center text-gray-100 bg-red-600 rounded-full shadow-xl ">
                        <span class="relative text-base font-semibold text-gray-200 ">
                          {" "}
                          10% OFF
                        </span>
                      </div>
                    ...
                    <div class="p-5 bg-gray-50 dark:bg-gray-900">
                      <div class="flex items-center justify-between mb-4">
                        ...
                        <a href="#" class="">
                          <svg
                            ...
                            height="16"
                            fill="currentColor"
                            class="text-red-500 dark:text-gray-400 bi bi-heart"
                            viewBox="0 0 16 16"
                          >
                      ...
                      <div class="mb-4 ">
                        <p class="text-lg ">
                          <span class="text-red-400 dark:text-gray-400">
                            $800.00
                          </span>
                          <span class="ml-2 text-gray-400 line-through dark:text-gray-400">
                            1500
                          </span>
                        </p>
                      </div>
                  ...
                  <div class="border border-gray-200 rounded-md dark:border-gray-800">
                    <div class="relative bg-gray-200">
                      ...
                      <div class="absolute top-0 right-0 z-10 m-2 flex items-center justify-center p-2 text-center bg-blue-600 ">
                        <span class="relative text-base font-normal text-gray-100 ">
                          {" "}
                          New
                        </span>
                      </div>
