            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
              <div class="p-6 mb-8 bg-white rounded shadow lg:mb-0 dark:bg-gray-900">
                ...
                <div class="flex items-center justify-between mb-3">
                  ...
                  <span class="inline-block px-2 py-1 ml-2 text-xs text-white bg-blue-500 rounded-full">
                    58%
                  </span>
                </div>
                <div class="relative w-full h-1 mb-2 bg-gray-200 rounded">
                  <div class="absolute top-0 left-0 w-4/6 h-full bg-blue-500 rounded "></div>
                </div>
              ...
              <div class="p-6 mb-8 bg-white rounded shadow lg:mb-0 dark:bg-gray-900">
                ...
                <div class="relative w-full h-1 mb-2 bg-gray-200 rounded">
                  <div class="absolute top-0 left-0 w-10/12 h-full bg-red-500 rounded "></div>
                </div>
                <p class="text-xs text-gray-500 dark:text-gray-400">
                  since last month
                </p>
              ...
              <div class="p-6 mb-8 bg-white rounded shadow lg:mb-0 dark:bg-gray-900">
                ...
                <div class="relative w-full h-1 mb-2 bg-gray-200 rounded">
                  <div class="absolute top-0 left-0 w-11/12 h-full bg-green-500 rounded "></div>
                </div>
                <p class="text-xs text-gray-500 dark:text-gray-400">
                  since last month
                </p>
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
              <div class="p-4 bg-white rounded-md shadow md:p-6 dark:bg-gray-900 ">
                <div class="flex flex-wrap justify-between mb-6">
                  <h2 class="py-1 text-xl font-semibold capitalize border-b border-blue-500 dark:text-gray-400">
                    Recent Orders
                  </h2>
                  <a
                    href=""
                    class="px-4 py-2 text-sm text-white capitalize bg-blue-500 rounded "
                  >
                    view all
                  </a>
                </div>
                <div>
                  <div class="flex justify-between mb-4">
                    ...
                    <div class="">
                      <span class="font-medium text-blue-400">Qty:1</span>
                    </div>
                  </div>
                  <div class="flex justify-between mb-4">
                    <div class="flex gap-2">
                  ...
                  <div class="flex items-center justify-between pt-6 overflow-x-auto">
                    <table class="w-full">
                      ...
                      <tbody>
                        <tr>
                          <td class="pt-6">
                            <div class="flex justify-center w-full px-2 py-2 cursor-pointer"></div>
                          </td>
                          <td class="pt-6">
                            <div class="flex justify-center w-full px-2 py-2 cursor-pointer"></div>
                          </td>
                            ...
                            <div class="w-full h-full">
                              <div class="flex items-center justify-center w-full rounded-full cursor-pointer">
                                <a
                                  role="link"
                                  tabindex="0"
                                  class="flex items-center justify-center w-8 h-8 text-base font-medium text-white bg-blue-600 rounded hover:bg-blue-500 "
                                >
                                  20
                                </a>
                              </div>
