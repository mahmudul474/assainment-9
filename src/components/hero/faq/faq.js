        ...
        <div  className="max-w-4xl mx-auto mb-12">
            <div  className="flex flex-wrap -mx-4">
                ...
                <div  className="w-full px-3 mb-6 md:w-1/3 lg:mb-0 lg:w-1/5">
                    <button
                         className="w-full py-6 bg-gray-100 rounded-xl dark:bg-gray-700 dark:hover:bg-gray-900 hover:bg-blue-100">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <p  className="text-lg font-semibold text-gray-500 dark:text-gray-400 ">Shipping</p>
                    </button>
                </div>
                <div  className="w-full px-4 mb-6 md:w-1/3 lg:w-1/5 lg:mb-0">
                    <button
                        ...
                        <p  className="text-lg font-semibold text-gray-500 dark:text-gray-400 ">Tool</p>
                    </button>
                </div>
                <div  className="w-full px-4 mb-6 md:w-1/3 lg:w-1/5 lg:mb-0">
                    <button
                         className="w-full py-6 bg-gray-100 rounded-xl hover:bg-blue-100 dark:bg-gray-700 dark:hover:bg-gray-900">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <p  className="text-lg font-semibold text-gray-500 dark:text-gray-400">Payments</p>
                    </button>
                </div>
                <div  className="w-full px-4 mb-6 md:w-1/3 lg:w-1/5 md:mb-0">
                    <button
                        ...
                        <p  className="text-lg font-semibold text-gray-500 dark:text-gray-400 ">Returns</p>
                    </button>
                </div>
            </div>
        </div>
