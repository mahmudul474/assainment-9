    ...
    <section className="flex items-center bg-gray-100 lg:h-screen font-poppins dark:bg-gray-900 ">
        <div className="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-3 md:grid-cols-2">
                <div>
                    ...
                    <div className="p-4 bg-white dark:bg-gray-700">
                        <div className="flex items-center justify-between mb-1">
                            <div>
                                <a href="">
                                    <h2 className="text-xl font-semibold dark:text-gray-300">Amit Robinson</h2>
                                </a>
                            </div>
                            <div className="flex">
                        ...
                        <div className="flex items-center justify-between ">
                            <div className="flex items-center">
                                ...
                                <span className="text-sm font-medium text-gray-700 dark:text-gray-400">3/23/2022</span>
                            </div>
                            <a href="#"
                ...
                <div>
                    ...
                    <div className="p-4 bg-white dark:bg-gray-700">
                        <div className="flex items-center justify-between mb-1">
                            <div>
                                <a href="">
                                    <h2 className="text-xl font-semibold dark:text-gray-300">Jacob Robinson</h2>
                                </a>
                            </div>
                            <div className="flex">
                                <a href="" className="mr-3 text-lg font-medium text-blue-600 dark:text-gray-300">
                ...
                <div>
                    <div className="relative w-full h-56">
                        <img src="https://i.postimg.cc/wT039J5Q/third.jpg" alt="" className="object-cover w-full h-full "/>
                        <span className="absolute top-0 left-0 px-2 py-1 mt-2 ml-2 text-xs text-white bg-blue-700">
                            Entertainment</span>
                    </div>
                    <div className="p-4 bg-white dark:bg-gray-700">
                        <div className="flex items-center justify-between mb-1">
                            <div>
                                <a href="">
                                    <h2 className="text-xl font-semibold dark:text-gray-300">John Smith</h2>
                                </a>
                            </div>
                            <div className="flex">
                                <a href="" className="mr-3 text-lg font-medium text-blue-600 dark:text-gray-300">
                        ...
                        <div className="flex items-center mb-4">
                            <a href="" className="mr-1 text-blue-600 dark:text-gray-400">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor"
                                    className="bi bi-geo-alt" viewBox="0 0 16 16">
                                    <path
                                        d="M12.166 8.94c-.524 1.062-1.234 2.12-1.96 3.07A31.493 31.493 0 0 1 8 14.58a31.481 31.481 0 0 1-2.206-2.57c-.726-.95-1.436-2.008-1.96-3.07C3.304 7.867 3 6.862 3 6a5 5 0 0 1 10 0c0 .862-.305 1.867-.834 2.94zM8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10z" />
