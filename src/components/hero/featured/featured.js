...
export default function featured() {
  return (
    <div><section class="flex items-center justify-center bg-gray-100 dark:bg-gray-800 lg:h-screen">
    <div class="px-4 py-20 mx-auto max-w-7xl">
        <div class="max-w-xl mx-auto">
            <div class="text-center ">
                <div class="relative flex flex-col items-center">
                    ...
                    <h1 class="text-5xl font-bold dark:text-white"> Our <span class="text-blue-500"> Features
                        </span> </h1>
        ...
        <div class="grid grid-cols-1 gap-x-4 gap-y-6 lg:gap-x-8 lg:gap-y-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="w-full p-8 mb-5 text-center transition-all bg-blue-500 rounded shadow hover:shadow-lg">
                ...
                <h3 class="mb-4 text-2xl font-semibold text-white"> Automatic Power Shields
                </h3>
