  ...
  return (
    <div>
      <div className="lg:block  mt-4 ">
        <nav
          className=" top-0 border-r transition-all left-0 dark:bg-gray-900 bottom-0 flex flex-col w-[280px] border-gray-200 dark:border-gray-800 bg-gray-50 overflow-hidden"
          id="sidenav"
        ></nav>
        <div className="flex justify-center ">
          <div>
            <img
              ...
              className="object-cover object-right w-16 h-16 mb-2 rounded-full"
              alt="person"
            />
        ...
        <div className="pb-6 mt-4 overflow-x-hidden h-screen  overflow-y-auto">
          <ul className="mb-8 text-sm">
            <li>
              <a
                href="#"
                className="flex items-center px-10 py-4 text-gray-700 dark:text-gray-400 group dark:hover:bg-gray-700 hover:bg-gray-100"
              >
            ...
            <li x-data="{ open: false }">
              <a
                href="#"
                className="flex items-center px-10 py-4 text-gray-700 group dark:text-gray-400 dark:hover:bg-gray-700 hover:bg-gray-100"
              >
                <span className="inline-block mr-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="pl-3 ml-3 transition border-gray-500 dropdown-section nested-menu">
                <ul className="text-sm font-medium">
                  <li>
                    <a
                      href="#"
                      className="flex items-center py-3 pl-3 pr-4 text-gray-700 rounded dark:text-gray-400 dark:hover:bg-gray-700 hover:bg-gray-100 "
                    >
