                    ...
                    <div  className="w-full px-4 md:w-1/4 lg:w-2/12 mb-11 lg:mb-0">
                        ...
                        <ul>
                            <li  className="flex items-center mb-4 ">
                                ...
                                <a href="#"
                                     className="inline-block text-base font-normal text-gray-300 dark:text-gray-400">Home</a>
                            </li>
                            <li  className="flex items-center mb-4 ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                     className="w-3 h-3 mr-1 text-white dark:text-gray-400 bi bi-chevron-right"
                                ...
                                <a href="#"  className="inline-block text-base font-normal text-gray-300 dark:text-gray-400">
                                    About Us</a>
                            </li>
                            <li  className="flex items-center mb-4 ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                <a href="#"
                                     className="inline-block text-base font-normal text-gray-300 dark:text-gray-400">Services</a>
                            </li>
                        </ul>
                    </div>
                    <div  className="w-full px-4 md:w-1/4 lg:w-2/12  lg:mb-0">
                        <h2  className="mb-4 text-xl font-bold text-gray-200 dark:text-gray-400">Features </h2>
                        <ul>
                            <li  className="flex items-center mb-4 ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                     className="w-3 h-3 mr-1 text-white dark:text-gray-400 bi bi-chevron-right"
                                ...
                                <a href="#"
                                     className="inline-block text-base font-normal text-gray-300 dark:text-gray-400">Products</a>
                            </li>
                            <li  className="flex items-center mb-4 ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                     className="w-3 h-3 mr-1 text-white dark:text-gray-400 bi bi-chevron-right"
                                ...
                                <a href="#"
                                     className="inline-block text-base font-normal text-gray-300 dark:text-gray-400">Business
                                </a>
                            </li>
                            <li  className="flex items-center mb-4 ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                <a href="#"
                                     className="inline-block text-base font-normal text-gray-300 dark:text-gray-400">Firm</a>
                            </li>
                        </ul>
                    </div>
                    <div  className="w-full px-4 lg:block hidden  mb-2 lg:mb-0 md:w-1/3 lg:w-4/12">
                        <h2  className="mb-4 text-lg font-bold text-gray-200 dark:text-gray-400">Gallery </h2>
